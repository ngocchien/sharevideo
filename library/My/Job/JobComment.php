...
class JobComment extends JobAbstract {
    /*
     * save comment
     */
    ...
    public function writeComment($params) {
        ...
        if (!$intResult) {
            echo General::getColoredString("ERROR: Cannot add comm id = {$id} to Search \n", 'light_cyan', 'red');
            return false;
        }

        echo General::getColoredString("Add add id: {$id} to Search Success", 'green');
